...
per2=0.3
per3=0.4
Tuğba_passgrade=(Tuğba_midterm*per1)+(Tuğba_project*per2)+(Tuğba_project*per3)
Tuğba_passgrade
...
studentsgrade_list=[]
studentsgrade_list.extend((Tuğba_passgrade,Ceren_passgrade,Fatoş_passgrade,Yıldız_passgrade,Zeynep_passgrade))
studentsgrade_list
studentsgrade_list.sort(reverse=True);
